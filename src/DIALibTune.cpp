...
protected:
  void registerOptionsAndFlags_() override
  {
    ...
    registerIntOption_("filter:min_charge", "<z>", 2, "Lowest precursor charge used. z1 is censored at the mobility ramp top on timsTOF; keep it out of CCS training", false);
    ...
    registerFlag_("cohort:no_inner_val", "Validate on the training set (selection becomes optimistic; TEST stays honest)");
    ...
    registerIntOption_("stop:patience", "<n>", 10, "Stop after this many non-progress validations", false);
  ...
  ExitCodes main_(int, const char**) override
  {
    ...
    p.train_size = static_cast<std::size_t>(std::max(0, getIntOption_("cohort:train_size")));
